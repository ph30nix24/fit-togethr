...
const Hero = () => {
  return (
    <section className="w-full h-screen relative z-1 px-40 py-20 bg-linear-to-br to-[#FBF5F1] from-[#f89d6f]/30  overflow-hidden">
      <div className="w-full h-full relative z-4 mt-15 flex gap-5">
        <div className="w-1/2 h-full relative z-1">
          ...
          <div className="mt-30">
            <button className="px-6 py-3 text-white bg-linear-to-tl to-[#FD5A48] from-[#ff8e6e]  rounded-lg font-medium hover:to-[#fd5a48]/90 hover:from-[#ff8e6e]/90 transition shadow-lg font-body cursor-pointer">
              Get Started
            </button>
            <button className="px-6 py-3 bg-linear-to-tl to-[#333] from-[#555] text-white rounded-lg font-medium hover:to-[#333]/90 hover:from-[#555]/90 transition ml-5 cursor-pointer font-body shadow-lg">
              Explore Workouts
            </button>
          </div>
        </div>
